...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bg-light rounded p-2">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm">
                            <a href="{{ route('admin.create') }}" class="text-decoration-none text-white">
                                <button class="btn btn-outline-primary fw-bold px-4 py-2"><i class="fas fa-plus"></i>
                                    <div class="d-none d-sm-inline"> New
                                </button>
                            </a>
                            {{-- <a href="{{ route('admin.export') }}" class="text-decoration-none">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button data-toggle="modal" data-target="#deleteModal"
                                        data-attr="{{ route('admin.destroy', $data->id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Menghapus <i id="modal_nama_admin"></i>
                </div>
    ...
    <script>
        function change_data_in_modal(e) {
            console.log($(e).data("nama_admin"));
            $("#modal_nama_admin").html($(e).data("nama_admin"));
